package com.mcliu.springtest.common.listener;
...
//		initQuartz();
	...
	private void initQuartz() {
		...
		try {
			// 获取配置文件路径
			String configFile = basePath + File.separator + "quartz.properties";
			if (configFile != null) {
	...
	private void initRootConfigPath() {
		...
		System.out.println("done! 配置文件根目录:" + basePath);
	}

	private void initLogback() {
		System.out.print("加载logback.xml配置文件....");

		String logRootPath = basePath + "/logback/logback.xml";
